...
Save previews to `.html-presentation-slides/slide-previews/` (style-a.html, style-b.html, style-c.html). Each should be self-contained and compact, showing one animated title slide.
...
- Keep the output as a single self-contained HTML Presentation Slides HTML file.
...
1. **Clean up** — Delete `.html-presentation-slides/slide-previews/` if it exists
